...
class SelfOriginalPeacokTeacher(FbDialogTeacher):
    def __init__(self, opt, shared=None):
        opt = copy.deepcopy(opt)
        try:
            cands = opt['task'].split(":")[2]
            ...
            use_cands = True
        opt['datafile'] = _path(opt, 'self_original_peacok', use_cands)
        super().__init__(opt, shared)


class SelfOriginalPeacokRetrievedTeacher(FbDialogTeacher):
    def __init__(self, opt, shared=None):
        opt = copy.deepcopy(opt)
        try:
            cands = opt['task'].split(":")[2]
            ...
            use_cands = True
        opt['datafile'] = _path(opt, 'self_original_peacok_retrieved', use_cands)
        super().__init__(opt, shared)


class SelfOriginalPeacokInducedTeacher(FbDialogTeacher):
    def __init__(self, opt, shared=None):
        opt = copy.deepcopy(opt)
        try:
            cands = opt['task'].split(":")[2]
            ...
            use_cands = True
        opt['datafile'] = _path(opt, 'self_original_peacok_induced', use_cands)
        super().__init__(opt, shared)

class SelfOriginalPeacokRandomInducedTeacher(FbDialogTeacher):
    def __init__(self, opt, shared=None):
        opt = copy.deepcopy(opt)
        try:
            cands = opt['task'].split(":")[2]
            ...
            use_cands = True
        opt['datafile'] = _path(opt, 'self_original_peacok_random_induced', use_cands)
        super().__init__(opt, shared)

class SelfOriginalPeacokRetrievedInducedTeacher(FbDialogTeacher):
    def __init__(self, opt, shared=None):
        opt = copy.deepcopy(opt)
        try:
            cands = opt['task'].split(":")[2]
            ...
            use_cands = True
        opt['datafile'] = _path(opt, 'self_original_peacok_retrieved_induced', use_cands)
        super().__init__(opt, shared)
